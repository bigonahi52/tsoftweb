...
export const products: Product[] = [
  {
    ...
    overview: [
      ...
      "ماژول نقره‌ای همه‌ی نیازهای روزمره‌ی یک فروشگاه را پوشش می‌دهد؛ و اگر کسب‌وکار شما بزرگ‌تر شد یا حسابدار دارید، ماژول طلایی با سند دستی، کدینگ درختی، تراز آزمایشی و گزارش‌های حسابداریِ متناسب با کدینگِ خودتان، یک حسابداری کامل در اختیارتان می‌گذارد.",
    ],
    features: [
      ...
      { title: "گزارش‌های کدینگ‌محور", desc: "گزارش‌های حسابداری دقیقاً بر اساس کدینگی که خودتان تعریف کرده‌اید.", icon: "report" },
      { title: "مشتری و حساب اشخاص", desc: "مانده‌حساب مشتریان، دریافت و پرداخت، چک و اعتبار.", icon: "users" },
    ],
    modules: [
      {
        name: "ماژول نقره‌ای",
      ...
      },
      {
        ...
        items: [
          ...
          "سند حسابداری دستی",
          "تعریف کدینگ درختی حساب‌ها",
          "تراز آزمایشی و گردش حساب‌ها",
          "گزارش‌های حسابداری بر اساس کدینگ شما",
          "مناسب فروشگاه‌های بزرگ و دارای حسابدار",
        ],
      },
    ],
    specs: [
  ...
  },
  {
    ...
    overview: [
      ...
      "ساختار کپیتال ساده و قدرتمند است: یک ارز پایه معرفی می‌کنید و بقیه‌ی ارزها را تعریف می‌کنید؛ هر روز نرخ هر ارز نسبت به ارز پایه وارد برنامه می‌شود. هنگام ثبت اسناد و فاکتورها، اگر نرخ همان لحظه تغییر کرده باشد، کاربر می‌تواند همان‌جا و داخل همان فرم، نرخ لحظه‌ای را وارد کند — بدون خروج از سند و بدون دوباره‌کاری.",
      "برای هر مشتری می‌توانید واحد ارز مشخص کنید؛ مبلغ‌ها به‌صورت خودکار به واحد ارزیِ همان مشتری تبدیل می‌شود. و در صورتحساب، مانده‌ی مشتری قابل تبدیل به هر یک از واحدهای ارزی است که داخل برنامه وارد کرده‌اید — تا هر طرف حساب، مانده را به ارزِ خودش ببیند.",
