...
/* دو محصول اصلی گروه نرم‌افزاری سرمایه (TSOFT) — هرکدام یک نرم‌افزار مستقل */
const HERO_PRODUCTS = [
  {
    id: "tisaft",
    name: "تیسافت",
    latin: "TSOFT",
    desc: "نرم‌افزار حسابداری و مدیریت فروشگاه و کسب‌وکار — برای بازار ایران",
    icon: "receipt",
    accent: "#16b87f",
  },
  {
    ...
    name: "کپیتال",
    latin: "CAPITAL",
    desc: "نرم‌افزار حسابداری چندارزی و مدیریت سرمایه",
    icon: "coins",
    accent: "#eaa63b",
  },
];
