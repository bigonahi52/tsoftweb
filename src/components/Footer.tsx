        ...
        <div className="grid gap-12 md:grid-cols-[1.3fr_1fr_1fr_1.2fr]">
          <div>
            ...
            <div className="mt-6 flex items-center gap-2 rounded-xl border border-gold-500/40 bg-gold-500/10 px-4 py-3 text-sm text-gold-400">
              ...
              ۱۳۸۵ — ۱۴۰۵ · از ۱۳۸۵ در کنار کسب‌وکارهای ایرانی
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3.5 text-sm">
              {products.map((p) => (
                <li key={p.id}>
                  <button onClick={() => nav({ page: "product", id: p.id })} className="link-underline text-ink-100 transition-colors hover:text-gold-400">
          ...
          <div>
            ...
            <ul className="mt-5 space-y-4 text-sm text-ink-100">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>شنبه تا پنجشنبه: ۹ تا ۱۴ و ۱۷ تا ۲۲<br />روزهای تعطیل: پشتیبانی تلفنی اضطراری</span>
              </li>
              <li className="flex items-start gap-3">
